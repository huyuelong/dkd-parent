...
import com.dkd.manager.domain.VendingMachine;
import com.dkd.manager.service.IVendingMachineService;
...
public class VendingMachineController extends BaseController
{
     ...
     * 查询设备管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:list')")
    @GetMapping("/list")
     ...
     * 导出设备管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:export')")
     ...
     * 获取设备管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增设备管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:add')")
     ...
     * 修改设备管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:edit')")
     ...
     * 删除设备管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vm:remove')")
