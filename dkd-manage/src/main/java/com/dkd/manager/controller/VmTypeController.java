...
import com.dkd.manager.domain.VmType;
import com.dkd.manager.service.IVmTypeService;
...
public class VmTypeController extends BaseController
{
     ...
     * 查询设备类型管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:list')")
    @GetMapping("/list")
     ...
     * 导出设备类型管理列表
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:export')")
     ...
     * 获取设备类型管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:add')")
     ...
     * 修改设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:edit')")
     ...
     * 删除设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manager:vmType:remove')")
